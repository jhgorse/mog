...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// PipelineBase::Nullify()
///
/// Put the pipeline in the NULL state.
///////////////////////////////////////////////////////////////////////////////////////////////////
void PipelineBase::Nullify()
{
	assert(gst_element_set_state(m_pPipeline, GST_STATE_NULL) != GST_STATE_CHANGE_FAILURE);
}
